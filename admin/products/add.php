	...
	<div class="panel panel-primary">
		...
		<form class="panel-body" method="POST" action="index.php?act=addsp" enctype = "multipart/form-data">
			<div class="form-group">
				...
				<label for="tp">Giá sản phẩm:</label>
				<input name="pricePro" type="text" class="form-control bg-info bg-gradient" id="tp">
				<label for="tp">Giá gốc:</label>
				<input name="delPro" type="text" class="form-control bg-info bg-gradient" id="tp">
				<p style="color :red"><?= (isset($thongbao['delPro'])? $thongbao['delPro'] : "") ?></p>
