...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../views/css/listProducts.css">
    <link rel="stylesheet" href="../views/css/productDetail.css">
    <link rel="stylesheet" href="../views/css/Login.css">
    <link rel="stylesheet" href="../views/css/listCate.css">
    ...
    <div class="main">
      <header class="container-header">
        <div class="container-header-child">
          ...
          <ul class="menu">
            <li><a href="../views/index.php" class="container-header-ul-item">TRANG CHỦ</a></li>
            <li class="menu-item">
            ...
            <li class="menu-item">
              <a id="over" href="#" class="container-header-ul-item">BỘ SƯU TẬP</a>
              <div class="menu-child">
                <div class="menu-child-item">
                  <h4>Element</h4>
                  <ul class="menu-list-item">
